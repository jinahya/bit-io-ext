...
class MicrosoftGuidTest {
    ...
    void read_ExpectedValue_KnownBytes() throws IOException {
        final var actual = MicrosoftGuid.INSTANCE.read(input(microsoftBytes()));
    ...
    void read_NullPointerException_NullInput() {
        assertThatNullPointerException()
                .isThrownBy(() -> MicrosoftGuid.INSTANCE.read(null))
    ...
    void write_NullPointerException_NullOutput() {
        assertThatNullPointerException()
                .isThrownBy(() -> MicrosoftGuid.INSTANCE.write(null, UUID.randomUUID()))
